    ...
    <>
      <nav className="bg-white border-gray-200">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <a href="#" className="text-[#101323] font-medium flex items-center gap-x-2"><span>Login</span><AiOutlineArrowRight /></a>
            </div>
            <button
          ...
          <div
            className={`items-center justify-between ${mobileDropdown ? 'block' : 'hidden'} w-full md:flex md:w-auto md:order-1`}
            id="navbar-sticky"
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white text-[#101323]">
              <li className="md:relative">
                ...
                <div
                  id="dropdownNavbar"
                  className={`z-10 ${dropdown1 ? 'block' : 'hidden'} font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 md:absolute md:top-8 md:-left-10`}
                >
                  <ul
              ...
              <li className="md:relative">
                ...
                <div
                  id="dropdownNavbar"
                  className={`z-10 ${dropdown2 ? 'block' : 'hidden'} font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 md:absolute md:top-8 md:-left-8`}
                >
                  <ul
                    className="py-2 text-sm text-gray-700"
                    aria-labelledby="dropdownLargeButton"
